...
개발은 C/C++, Python, NodeJS, Go, React, SolidJS, Java, Typescript</br>
...
바닥부터 엔진 개발 가능, 처음 하는 언어로 개발 가능, 다른 언어로 포팅 가능합니다.</br>
소스가 없는 프로그램의 수정 및 기능 추가, 재구현 가능합니다.</br>
</br>
실무 과제의 상당수는 저작권과 문제로 공개하지 못하지만, 공개 가능한 범위의 작업은 계속 추가합니다.</br>

위 사항들은 AI 에이전트 없이 가능했었지만, 이제 더 쉽고 빠르게 가능합니다.</br>
현재는 가이드 주고 검수 및 검증만 하는 바이브 코딩으로만 작업합니다</br>
감사합니다.</br>
</p>
